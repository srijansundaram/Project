...
<html>
<head>
    <title>Regency Hotel|Queries Raised</title>
    ...
    <div class="transparent-box">
        <%
            ...
            try {
                ...
                // Count total records
                String countSql = "SELECT COUNT(*) AS total FROM Queries";
                ...
                String sql = "SELECT Name, Email, Message, SubmittedAt FROM Queries LIMIT " + pageSize + " OFFSET " + offset;
        ...
        %>
                            <tr>
                                ...
                                <td><%= resultSet.getTimestamp("SubmittedAt") %></td>
                            </tr>
        <%
                    }
        %>
