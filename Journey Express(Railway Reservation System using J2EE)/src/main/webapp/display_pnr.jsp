    ...
    <div class="table-container">
        ...
        %>
                            <tr>
                                ...
                                <td><%= arrivalTime %></td>
                                <td>
                                   <a href="DownloadJPG?pnr=<%= ticketPNR %>&name=<%= name %>&age=<%= age %>&mobile=<%= mobile %>&origin=<%= origin %>&destination=<%= destination %>&travelDate=<%= travelDate %>&berthPreference=<%= berthPreference %>&trainName=<%= trainName %>&departureTime=<%= departureTime %>&arrivalTime=<%= arrivalTime %>&trainClass=<%= trainclass %>&fare=<%= fare %>" class="download-button">Download Ticket</a>
								<br>
                                   <a href="cancelTicket.jsp?pnr=<%= ticketPNR %>" class="signup-image-link">Cancel Your Ticket</a>
                                </td>
                            </tr>
        <%
                    }
