...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Journey Express|Ticket Confirmation</title>
	...
	<body>
		...
		<div class="ticket-details">
		    ...
		    <p><strong>Berth:</strong> <%= request.getParameter("berthPreference") %></p>
		    ...
		    <form action="DownloadJPG" method="post">
		        ...
		        <input type="hidden" name="trainClass" value="<%= request.getParameter("class") %>">
