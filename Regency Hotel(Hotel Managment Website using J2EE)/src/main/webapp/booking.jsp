...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Regency Hotel|PNR Status</title>
	...
	<body style="margin: 0; padding: 0; height: 100vh; width: 100vw; display: flex; 
		...
		<div class="center-container">
	        <h1>
	            <span style="color:#fe5b3d;">Check</span> Booking
	        </h1>
   		</div>	
		<div class="form-container" style = "background-color: rgba(255, 255, 255, 0.85);">
		    <form action="display_bookingdetails.jsp" method="post">
	        	<div class="form-group">
		            <div class="input-box">
		                <label for="name">Booking Number</label>
		                <input type="search" name="pnr" id="name" placeholder="Enter Your Booking Number" required>
		            </div>
		        </div>
