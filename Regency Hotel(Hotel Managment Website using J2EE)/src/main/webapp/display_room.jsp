...
<html>
<head>
    <title>Regency Hotel|Room Details</title>
    ...
    <div class="transparent-box">
        <%
            ...
            try {
                ...
                String countSql = "SELECT COUNT(*) AS total FROM Room";
                ...
                String sql = "SELECT RoomType, Fare, Capacity, Status FROM Room LIMIT " + pageSize + " OFFSET " + ((currentPage - 1) * pageSize);
